  ...
  <div class="add-true add-new-question">
      <div class="inner-head">
          <div class="d-flex justify-content-between">
              <div>
                  <h6 class="mt-2 "> نوع السؤال: <span>صخ وخطأ</span></h6>
              </div>
              <div class="d-flex">
       ...
       <el-form :model="question" ref="truefalsequestion" :class="{'add-question-form': true, 'arabic-form': $i18n.locale == 'ar', 'english-form': $i18n.locale == 'en', }">
      ...
      <div class="row">
            <div class="col-md-6">
                <div class="d-flex">
                    ...
                    >
                    <el-radio v-model="question.modelAnswer" :label="0"> {{' '}} </el-radio>
                    </el-form-item>

                    <h6 v-if="$i18n.locale == 'ar'" class="d-inline-block pt-2">
                        إجابة صحيحة
                    </h6>
                    <h6 v-else class="d-inline-block pt-2">
                        True
                    </h6>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="d-flex">
                    ...
                    >
                    <el-radio v-model="question.modelAnswer" :label="1"> {{' '}} </el-radio>
                    </el-form-item>
