<template>
  <div>
        <el-form :model="addQuestion" ref="addQuestion" :class="{'add-question-form': true, 'arabic-form': $i18n.locale == 'ar', 'english-form': $i18n.locale == 'en', }">
            <el-form-item
                label="رأس السؤال"
                prop="head"
                :rules="[
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex">
                            ...
                            label=" "
                                ...
                                >
                                    <el-radio v-model="addQuestion.modelAnswer" :label="0"> {{' '}} </el-radio>
                            </el-form-item>
                            <el-form-item
                            class="fullwidth"
                                label="الإجابة"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex">
                            ...
                            label=" "
                                ...
                                >
                                    <el-radio v-model="addQuestion.modelAnswer" :label="1"> {{' '}} </el-radio>
                            </el-form-item>
                            <el-form-item
                            class="fullwidth"
                                label="الإجابة"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex">
                            ...
                            label=" "
                                ...
                                >
                                    <el-radio v-model="addQuestion.modelAnswer" :label="2"> {{' '}} </el-radio>
                            </el-form-item>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex">
                            ...
                            label=" "
                                ...
                                >
                                    <el-radio v-model="addQuestion.modelAnswer" :label="3"> {{' '}} </el-radio>
                            </el-form-item>
                    ...
                    <div class="col-md-6 true-false">
                        <div>
                            <el-form-item
                                ...
                                >
                                    <el-radio v-model="addQuestion.modelAnswer" :label="true"> صح </el-radio>
                            </el-form-item>
                        </div>
                    </div>
                     ...
                     <div class="col-md-6 true-false">
                        <div>
                            <el-form-item
                                ...
                                >
                                    <el-radio v-model="addQuestion.modelAnswer" :label="false"> خطأ </el-radio>
                            </el-form-item>
                        </div>
                    </div>
                </div>
            ...
            <template v-if="type == 'complete'">
                ...
                <vs-button class="mb-3" @click.prevent="addQuestion.complete.push('')"> إضافة إجابة </vs-button>
                <div class="row">
                    <div class="col-md-12" v-for="(answer,index) in addQuestion.complete" :key="index">
                        <div class="d-flex">
                            <el-form-item
                                :prop="'complete['+index+']'"
                                :rules="[
                            ...
                            <div v-if="index != 0">
                                <vs-button color="danger" @click.prevent="addQuestion.complete.splice(index, 1)"><i class="el-icon-circle-close"></i></vs-button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <el-form-item class="mt-4 d-flex justify-content-end">
                ...
                <div class="d-flex flex-row-reverse">
                    <el-button class="form-button mt-0 mr-2 ml-2" type="danger" @click="cancelAdd"
                    >
                    <i class="el-icon-circle-close"></i>
                    {{$t('Validation.close')}}</el-button
                    >
                    <el-button class="form-button "  type="warning" @click="validateAddQuestion('addQuestion')"
...
export default {
    ...
    methods:{
        ...
        addNewQuestion(){
            ...
            this.$axios.post(qryParam, formData).then(res => {
