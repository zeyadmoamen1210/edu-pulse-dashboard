  ...
  <div>
    <div v-for="(question, index) in allQuestions" :key="question.id">
        ...
        >
          ...
          <template slot="add-delete-question-from-exam">
              <div class="add-delete-from-exam">
                ...
                <el-button class="d-block delete-from-exam-btn" @click="deleteQuestionFromExam(question)" v-if="examQuestions && examQuestions.findIndex(ele => ele.id == question.id) > -1" type="text">إزالة من الامتحان</el-button>

                <div v-else>
                  <el-input type="number" v-model.number="question.point"></el-input>
                  <el-button class="d-block" type="text" @click="addQuestionToExam(question)"> إضافة إلي الامتحان </el-button>
                </div>
      ...
      <template v-if="question.type == 'group'">
          <Group :question="question" :index="Number(allQuestionsCount)  + index" :toExam="toExam">
