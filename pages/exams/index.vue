      ...
      <div class="exams">
        ...
        <section class="exams-tab" v-if="active == 1">
          <div class="edu-tabs">
            ...
            <button
              :class="{ btn: true, active: examsActive == 2 }"
              @click="examsActive = 2"
            >
              الوحدات
            </button>
              ...
              <div class="row">
                    ...
                    <div class="mr-1 ml-1 mb-1">
                      <div>
                        <el-select
                          ...
                          @change="selectedClassChanged()"
                          :placeholder="$t('subjects.Class')"
                        >
                          <el-option
                ...
                <div class="col-md-3">
                  <div class="d-flex flex-row-reverse">
                    <el-button @click="openAddExamToSubjectModel" type="warning"
                      ...
                      >
                        <div slot="update-delete">
                          <div class="d-flex update-delete-exam text-center">
                            <button
                              @click="openUpdateExamModel('subject', {...exam})"
                              :class="{
                                btn: true,
                                'w-50': true,
              ...
              <div v-else>
                ...
                <div>
                  ...
                  <div slot="update-delete">
                        <div class="d-flex update-delete-exam text-center">
                          <button
                            @click="openUpdateExamModel('subject', {...currSubjectExam})"
                            :class="{
                              btn: true,
                              'w-50': true,
                              'border-right': $i18n.locale == 'en',
          ...
          <section v-if="examsActive == 2">
            ...
            <div class="exams">
              <div class="row" v-if="!unitShowQuestionsOfExam">
                <div class="col-md-2" v-for="exam in unitsExams" :key="exam.id">
                  <div>
                    <Exam
                      :exam="exam"
              ...
              <div v-else>
                ...
                <div>
                  ...
                  <div slot="update-delete">
                        <div class="d-flex update-delete-exam text-center">
                          <button
                            @click="openUpdateExamModel('unit', {...currUnitExam})"
                            :class="{
                              btn: true,
                              'w-50': true,
                              'border-right': $i18n.locale == 'en',
              ...
              <div v-else>
                ...
                <div>
                  ...
                  <div slot="update-delete">
                        <div class="d-flex update-delete-exam text-center">
                          <button
                            @click="openUpdateExamModel('lesson', {...currLessonExam})"
                            :class="{
                              btn: true,
                              'w-50': true,
                              'border-right': $i18n.locale == 'en',
...
export default {
  ...
  methods: {
    ...
    selectedSectionChanged() {
      this.selectedSubject = this.selectedUnit = this.selectedLesson = "";
      this.allSubjects = this.allUnites = this.allLessons = [];
    ...
    selectedSubjectChanged() {
      ...
      if (this.selectedSubject != "") {
        ...
        this.subjectExams = [];
        this.subjectUpdateModel = this.unitUpdateModel = this.lessonUpdateModel = false;
        this.addSubjectExamModel = this.addUnitExamModel = this.addLessonExamModel = false;
      }
    },
    selectedUnitChanged() {
      this.selectedLesson = "";
    ...
    getExamQuestions(){
      this.addUnitExamModel = this.addLessonExamModel = this.addSubjectExamModel = false;
      this.lessonUpdateModel = this.unitUpdateModel = this.subjectUpdateModel = false;
    ...
    openUpdateExamModel(type, exam) {
      this.addLessonExamModel = this.addSubjectExamModel = this.addUnitExamModel = false;
    ...
    getSubjectExams() {
      ...
      const loading = this.$vs.loading();
      this.$axios
        .get(`/subjects/${this.selectedSubject}/exams?paginate=false`)
        .then((res) => {
    ...
    getLessonExams() {
      ...
      const loading = this.$vs.loading();
      this.$axios
        .get(`/lessons/${this.selectedLesson}/exams?paginate=false`)
        .then((res) => {
      ...
      if (this.selectedClass) {
        this.$axios
          .get(
            ...
            }${this.selectedSystem > 0 ? "&paginate=false" : "?paginate=false"}`
          )
          .then((res) => {
    ...
    getSubjects() {
      ...
      this.$axios
        .get(`/sections/${this.selectedSection}/subjects?paginate=false`)
        .then((res) => {
    ...
    getUnites() {
      ...
      this.$axios
        .get(`/subjects/${this.selectedSubject}/units?paginate=false`)
        .then((res) => {
    ...
    getLessons() {
      ...
      this.$axios
        .get(`/units/${this.selectedUnit}/lessons?paginate=false`)
        .then((res) => {
